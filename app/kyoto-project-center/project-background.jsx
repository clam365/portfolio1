    ...
    return (
        <div className={""}>
            ...
            <div className={"mt-20 space-y-2 scroll-mt-40"} id={"ideation"}>
                <h1 className={"text-gray"}>IDEATION</h1>
