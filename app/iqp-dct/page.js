                ...
                <div className={"flex flex-col lg:flex-row"}>
                    <nav className="lg:w-1/4 hidden lg:block">
                        <ul className="space-y-4 sticky top-24 p-10">
                            ...
                            <li><a href="#challenge" className="hover:text-black text-newGray transition">Challenge</a>
                            </li>
                            <li><a href="#uxr" className="hover:text-black text-newGray transition">User Research</a>
                            </li>
