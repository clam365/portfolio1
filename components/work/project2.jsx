...
export default function Project1() {
    return (
        <div className="group">
            <Link href="/iqp-dct" className="relative z-0">
                <div>
                    <Image src="/mockup2.png" alt="KyotoMockup" width={4000} height={2800} className="w-full rounded-2xl drop-shadow-lg transition-transform duration-300 ease-in-out hover:scale-[102%] min-h-[240px] object-cover"/>
