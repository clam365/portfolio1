...
export default function Project5() {
    return (
        <div className="group">
            <Link href="/schneiderelectric" className="relative z-0">
                <div>
                    <Image src="/images/se.jpg" alt="wildscape" width={4000} height={1565} className="w-full rounded-2xl drop-shadow-lg transition-transform duration-300 ease-in-out hover:scale-[102%] min-h-[240px] object-cover"/>
